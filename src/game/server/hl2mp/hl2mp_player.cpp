...
void CHL2MP_Player::FireBullets ( const FireBulletsInfo_t &info )
{
	...
	lagcompensation->StartLagCompensation( this, /*this->GetCurrentCommand()*/ LAG_COMPENSATE_HITBOXES );
...
//-----------------------------------------------------------------------------
void CHL2MP_Player::SetupBones( matrix3x4a_t *pBoneToWorld, int boneMask )
{
