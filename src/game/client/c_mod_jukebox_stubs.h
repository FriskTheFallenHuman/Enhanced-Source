...
//
//=============================================================================//
#ifndef _C_MOD_JUKEBOX_STUBS_H
#define _C_MOD_JUKEBOX_STUBS_H
...
//-----------------------------------------------------------------------------
class CJukeboxPlaylist : public CGameEventListener, public CAutoGameSystem
{
public:
...
extern CJukeboxPlaylist g_Jukebox;

#endif // _C_MOD_JUKEBOX_STUBS_H