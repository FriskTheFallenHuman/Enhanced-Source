...
// Purpose: 
//-----------------------------------------------------------------------------
bool C_HL2MP_Player::Simulate( void )
{
...
void C_HL2MP_Player::UpdateFlashlight()
{
	...
	if ( IsEffectActive( EF_DIMLIGHT ) )
	{
		if (!m_pHL2MPFlashLightEffect)
		{
			...
			m_pHL2MPFlashLightEffect = new CHL2MPFlashlightEffect();
...
{
	CHeadlightEffect::UpdateLight( vecPos, vecDir, vecRight, vecUp, nDistance );
}
